...
<div>
    <div class="uk-card uk-card-default">
        <div class="uk-card-header">
            <div class="uk-text-left uk-text-small uk-text-muted">{{date .questionContent.CreatedAt "Y-m-d H:i:s"}}
            </div>
        ...
        {{if ne .questionContent.Answer ""}}
            ...
            <div class="uk-card-footer">
                {{if ne .error ""}}
                    ...
                    {{end}}
                    {{if eq .isLogin true}}
                        <form class="uk-float-right" method="post"
                        ...
                        {{if and (eq .user.PageID .pageContent.ID) (eq .questionContent.Answer "") }}
                            ...
                            {{if and (eq .user.PageID .pageContent.ID) (eq .questionContent.Answer "") }}
                                <form class="uk-float-left" method="post" action="/ban/{{ .pageContent.Domain }}/{{ .questionContent.ID }}">
                                    {{ .xsrfdata }}
