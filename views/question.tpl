...
<div>
    <div class="uk-card uk-card-default">
        ...
        <div class="uk-card-footer">
            ...
            {{end}}
            {{if eq .isLogin true}}
                {{if eq .user.PageID .pageContent.ID}}
                    <form class="uk-float-right" method="post" action="/delete/{{ .pageContent.Domain }}/{{ .questionContent.ID }}">
                            {{ .xsrfdata }}
                ...
                {{if and (eq .user.PageID .pageContent.ID) (eq .questionContent.Answer "") }}
                    ...
                    <form method="post">
                        ...
                        <div class="uk-margin uk-text-center">
                            <textarea name="answer" class="uk-textarea" rows="3" maxlength="1000"
